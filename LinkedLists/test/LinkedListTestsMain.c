...
CLOVE_TEST(RemoveHead)
{
    ...
    int removed = ListRemoveValue(&head, head->value);

    CLOVE_INT_EQ(10, removed);
...
CLOVE_TEST(RemoveValueInsideList)
{
    ...
    int removed = ListRemoveValue(&head, head->next->value);

    CLOVE_INT_EQ(20, removed);
...
CLOVE_TEST(RemoveLastValue)
{
    ...
    int removed = ListRemoveValue(&head, head->next->next->value);

    CLOVE_INT_EQ(30, removed);
